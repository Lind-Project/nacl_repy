...
myfd = lind_test_server.get_fs_call(-1,"open_syscall")('/foo', O_RDWR, S_IRWXA)
...
assert lind_test_server.get_net_call(-1,"bind_syscall")(sockfd, '10.0.0.1', 50102) == 0
try:
    lind_test_server.get_net_call(-1,"setshutdown_syscall")(sockfd, SHUT_RD)
except:
    pass
