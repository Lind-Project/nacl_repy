...
assert(lind_test_server.get_net_call(-1,"getsockname_syscall")(sockfd) == ('0.0.0.0', 0))


# should work...
lind_test_server.get_net_call(-1,"bind_syscall")(sockfd,'127.0.0.1',50102)

assert(lind_test_server.get_net_call(-1,"getsockname_syscall")(sockfd) == ('127.0.0.1', 50102))

try:
  lind_test_server.get_net_call(-1,"bind_syscall")(sockfd,'127.0.0.1',50103)
