...
if __name__ == '__main__':
    ...
    myfd = lind_test_server.get_fs_call(-1,"open_syscall")(TEST2_FILENAME, \
                                      O_CREAT | O_EXCL | O_RDWR, S_IRWXA)

    # write should succeed
    message = '================================================================================================================================'
    assert(lind_test_server.get_fs_call(-1,"write_syscall")(myfd, message) == len(message))

    lind_test_server.get_fs_call(-1,"close_syscall")(myfd)

    lind_test_server.get_fs_call(-1,"unlink_syscall")(TEST2_FILENAME)
